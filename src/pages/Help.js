...
import imgSlideHelp1 from '../assets/help1.jpg'
import img11 from '../assets/11.png'
import img22 from '../assets/22.png'
import img33 from '../assets/help3.png'
import img44 from '../assets/help4.png'
import img55 from '../assets/help5.png'
    ...
    return(
        ...
        {/* <Helmet>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.instruct}>
                    <p >3.  В составленный шаблон заключения из левого бокового меню можно дополнительно добавить требующиеся повреждения, а из правого бокового меню - патологию, нажимая на них:</p>
                    <img src={img33} alt="СМЭ повреждений" className={styles.imgHelp} />
                </div>
                <div className={styles.instruct}>
                    <p >4.  Добавленные в заключение повреждения подсвечиваются в боковом меню синим цветом, а патология - зеленым, и таким же цветом они выделены в соответствующих разделах самого заключения (в описании, в данных лабораторных и специальных исследований, в диагнозе, в выводах). Если требуется убрать какое-либо выбранное дополнительное повреждение или патологию, нужно повторно нажать на них:</p>
                    <img src={img44} alt="Давность смерти" className={styles.imgHelp} />
                </div>
                <div className={styles.instruct}>
                    <p >5.  После того как шаблон заключения составлен, для дальнейшей работы с ним его можно сохранить на компьютер:</p>
