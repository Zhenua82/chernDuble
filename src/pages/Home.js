...
function Home() {
    ...
    return (
        ...
        <Helmet>
            ...
            <meta
            name="description"
            content="Составление заключений по судебно-медицинской экспертизе трупа, главная страница конструктора заключений по смэ трупа."
            /> */}
            ...
            <h2 style={{color:'red'}}>Рабочая версия с localStorage и HashRouter пересборка</h2>
            ...
            <img src={imgSlide33} alt="Конструктор смэ" className={styles.imgHome} width="1811" height="1018"/>
            <Footer></Footer>           
        </>
    )
}
