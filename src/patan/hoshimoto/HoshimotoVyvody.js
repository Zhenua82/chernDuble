function HoshimotoVyvody(){
    return (
        <p id="MsoBodyTextIndent" className="green"> При жизни имелся аутоиммунный тиреоидит, хроническая форма (тиреоидит Хашимото): лимфоцитарная инфильтрация и очаговый фиброз 
...
export default HoshimotoVyvody