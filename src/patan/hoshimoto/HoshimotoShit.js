function HoshimotoShit(){
    return (
        <p id="MsoBodyTextIndent" className="green">
        При аутоиммунном тиреоидите с гипотиреозом щитовидная железа часто увеличена, имеет диффузное или очаговое утолщение. Это состояние известно как зоб. Увеличение может 
