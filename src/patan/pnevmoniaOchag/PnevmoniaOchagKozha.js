function PnevmoniaOchagKozha(){
    return (
        <p id="MsoBodyTextIndent" className="green">При очаговой пневмонии можно выявить следующие возможные особенности, которые косвенно или прямо указывают на заболевание:
...
-	Отеки нижних конечностей (могут быть обусловлены правожелудочковой недостаточностью вследствие гипоксии).
...
export default PnevmoniaOchagKozha