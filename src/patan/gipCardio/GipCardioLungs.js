function GipCardioLungs(){
    return (
        <p id="MsoBodyTextIndent" className="green"> При гипертрофической кардиомиопатии из-за хронической сердечной недостаточности в легких возможны следующие изменения:
