function DilCardioPechen(){
    return (
        <p id="MsoBodyTextIndent" className="green">При дилатационной кардиомиопатии возможно обнаружить следующие изменения в печени:
...
export default DilCardioPechen