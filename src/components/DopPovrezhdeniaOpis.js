...
import UshibRanaMkOpis from '../povrezhdenia/ushibRanaMk/UshibRanaMkOpis';
import ColotoRezMkOpis from '../povrezhdenia/colotoRezMk/ColotoRezMkOpis';
import PloskKostjNoogrOpis from '../povrezhdenia/ploskKostjNoogr/PloskKostjNoogrOpis';
import PloskKostjOgrOpis from '../povrezhdenia/ploskKostjOgr/PloskKostjOgrOpis';
import ProlezheniOpis from '../povrezhdenia/prolezheni/ProlezheniOpis';
...
function DopPovrezhdeniaOpis() {
    ...
    return (
        <>
            ...
            {/* Ушибленная рана + перелом кости (мк): */}
            {ushibRanaMk && <UshibRanaMkOpis/>}
            ...
            {/* Перелом плоск кости огр поверх + мк: */}
            {ploskKostjOgr && <PloskKostjOgrOpis/>}
            {/* Перелом плоск кости неогр поверх + мк: */}
            {ploskKostjNoogr && <PloskKostjNoogrOpis/>}
            {/* Бампер-перелом: */}
